...
public class Block
{
    ...
    {
        GRASS, DIRT, STONE, DIAMOND, BEDROCK, REDSTONE, GOLD,
        NOCRACK, CRACK1, CRACK2, CRACK3, CRACK4, CRACK5, AIR
    };
    ...
    int currentHealth;
    int[] BlockHealthMax = { 3, 2, 4, 5, -1, 4, 5, 0, 0, 0, 0, 0, 0, 0 };
    ...
    Vector2[,] blockUVs = { 
        ...
        /*NOCRACK*/         {new Vector2( 0.6875f, 0.25f ), new Vector2( 0.75f, 0.25f),
                                new Vector2( 0.6875f, 0.3125f ),new Vector2( 0.75f, 0.3125f )},

        /*CRACK1*/         {new Vector2( 0.0625f, 0f ), new Vector2( 0.125f, 0f),
                                new Vector2( 0.0625f, 0.0625f ),new Vector2( 0.125f, 0.0625f )},

        /*CRACK2*/         {new Vector2( 0.125f, 0 ), new Vector2( 0.1875f, 0f),
                                new Vector2( 0.125f, 0.0625f ),new Vector2( 0.1875f, 0.0625f )},

        /*CRACK3*/         {new Vector2( 0.3125f, 0 ), new Vector2( 0.375f, 0f),
                                new Vector2( 0.3125f, 0.0625f ),new Vector2( 0.375f, 0.0625f )},

        /*CRACK4*/         {new Vector2( 0.4375f, 0 ), new Vector2( 0.5f, 0f),
                                new Vector2( 0.4375f, 0.0625f ),new Vector2( 0.5f, 0.0625f )},

        /*CRACK5*/         {new Vector2( 0.5625f, 0 ), new Vector2( 0.625f, 0f),
                                new Vector2( 0.5625f, 0.0625f ),new Vector2( 0.625f, 0.0625f )}
